...
#include "behavior_trees/Bag_Detected.h"
...
{
  sub_ = n_.subscribe("bbx_bag", 1, &fsm_robocup::Person_Detected::messageCallback, this);
}
void
...
{
  factory.registerNodeType<fsm_robocup::Person_Detected>("Person_Detected");
}