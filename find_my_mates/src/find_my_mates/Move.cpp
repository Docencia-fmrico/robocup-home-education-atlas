...
Move::on_halt()
{
  ...
  setOutput("position", pos);
  ROS_INFO("Current position %lf", pos.position.x);
}
...
BT_REGISTER_NODES(factory)
{
    ...
    {
      return std::make_unique<find_my_mates::Move>(
        name, "move_base", config);
    };

  factory.registerBuilder<find_my_mates::Move>(
    "Move", builder);
}